# Graphite - AI Assessment Creator

An AI-powered assessment creator featuring asynchronous generation, real-time UI updates, and print-ready output. Graphite allows educators to upload materials and define specific question parameters to automatically generate high-quality examination papers.
...
```env
PORT=8000
MONGODB_URI=mongodb://localhost:27017/Graphite
...
Deployed Link : https://Graphite-q3j4.vercel.app/ ;