  ...
  const statCards: StatCard[] = [
    {
      ...
      trend: stats.totalGenerations > 0 ? 'All time usage' : 'No data yet',
      positive: stats.totalGenerations > 0,
      icon: <Zap size={14} className="text-slate-400" />,
    },
    {
      label: 'Rubrics Created',
      value: stats.totalRubrics,
      trend: stats.totalRubrics > 0 ? 'All time usage' : 'No data yet',
      positive: stats.totalRubrics > 0,
      icon: <LayoutList size={14} className="text-slate-400" />,
    },
    {
      label: 'Analyses Run',
      value: stats.totalAnalyses,
      trend: stats.totalAnalyses > 0 ? 'All time usage' : 'No data yet',
      positive: stats.totalAnalyses > 0,
      icon: <Target size={14} className="text-slate-400" />,
    },
    {
      label: 'Lesson Summaries',
      value: stats.totalSummaries,
      trend: stats.totalSummaries > 0 ? 'All time usage' : 'No data yet',
      positive: stats.totalSummaries > 0,
      icon: <BookOpenCheck size={14} className="text-slate-400" />,
    },
    {
      label: 'Assignments Created',
      value: stats.totalAssignments,
      trend: stats.totalAssignments > 0 ? 'All time usage' : 'No data yet',
      positive: stats.totalAssignments > 0,
